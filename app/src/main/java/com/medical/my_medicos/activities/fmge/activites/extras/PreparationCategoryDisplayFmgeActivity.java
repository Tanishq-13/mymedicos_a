...
import com.medical.my_medicos.activities.fmge.activites.internalfragments.PreparationSubCategoryFmgeActivity;
...
import com.medical.my_medicos.databinding.ActivityPreparationCategoryDisplayFmgeBinding;

public class PreparationCategoryDisplayFmgeActivity extends AppCompatActivity {

    ActivityPreparationCategoryDisplayFmgeBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityPreparationCategoryDisplayFmgeBinding.inflate(getLayoutInflater());
...
//        getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
    ...
    private void startSubCategoryActivity(String categoryTitle) {
        Intent intent = new Intent(this, PreparationSubCategoryFmgeActivity.class);
