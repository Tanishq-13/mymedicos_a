...
public class PGPastGTResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gotopghome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(PGPastGTResult.this, PgprepActivity.class);
                startActivity(i);
            }
        });
            ...
            idSubcollectionRef.document(id).get().addOnCompleteListener(task -> {
                if (task.isSuccessful()) {
                    if (task.getResult().exists()) {
                        ...
                        Toast.makeText(PGPastGTResult.this, "No data found", Toast.LENGTH_SHORT).show();
                    }
                } else {
