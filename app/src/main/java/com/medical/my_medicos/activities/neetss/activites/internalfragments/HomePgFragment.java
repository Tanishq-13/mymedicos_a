...
import com.medical.my_medicos.activities.neetss.activites.extras.PreparationCategoryDisplayActivity;
import com.medical.my_medicos.activities.neetss.activites.extras.PreparationCategoryMaterialDisplayActivity;
import com.medical.my_medicos.activities.neetss.activites.extras.RecetUpdatesNoticeActivity;
import com.medical.my_medicos.activities.neetss.activites.extras.TermsandConditionsDialogueFragmentPg;
...
public class HomePgFragment extends Fragment {
    ...
    QuestionBankSSAdapter questionsAdapter;
    ArrayList<QuestionSS> questionsforpg;
...
//                                    quizpg.add(quizday);
    ...
    void initQuestionsBanks() {
        ...
        questionsAdapter = new QuestionBankSSAdapter(getActivity(), questionsforpg);
            ...
            try {
                ...
                if(object.getString("status").equals("success")){
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        QuestionSS questionbankItem = new QuestionSS(
