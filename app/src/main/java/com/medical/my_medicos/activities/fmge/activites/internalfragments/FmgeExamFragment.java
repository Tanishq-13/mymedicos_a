...
import com.medical.my_medicos.activities.fmge.activites.internalfragments.insiderfragments.LiveFmgeFragment;
import com.medical.my_medicos.activities.fmge.activites.internalfragments.insiderfragments.PastFmgeFragment;
import com.medical.my_medicos.activities.fmge.activites.internalfragments.insiderfragments.UpcomingFmgeFragment;
...
public class FmgeExamFragment extends Fragment {

    private ViewFlipper viewFlipperPg;
    private Handler handlerpg;
    private ArrayList<QuizFmge> quizpgneet;
    private FmgeQuizAdapter quizAdapterneet;
    ...
    public static FmgeExamFragment newInstance() {
        FmgeExamFragment fragment = new FmgeExamFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        FragmentStateAdapter adapter = new FragmentStateAdapter(this) {
            ...
            public Fragment createFragment(int position) {
                switch (position) {
                    case 1:
                        return new UpcomingFmgeFragment();
                    case 2:
                        return new PastFmgeFragment();
                    default:
