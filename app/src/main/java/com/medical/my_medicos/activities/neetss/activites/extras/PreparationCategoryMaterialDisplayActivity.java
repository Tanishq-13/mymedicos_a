...
import com.medical.my_medicos.activities.neetss.activites.internalfragments.PreparationSubCategorySSForMaterialActivity;
...
//        getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
    ...
    private void startSubCategoryActivity(String categoryTitle) {
        Intent intent = new Intent(this, PreparationSubCategorySSForMaterialActivity.class);
