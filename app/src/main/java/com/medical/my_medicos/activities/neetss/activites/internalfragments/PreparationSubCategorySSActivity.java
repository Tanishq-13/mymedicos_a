...
public class PreparationSubCategorySSActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPreparationSubCategoryBinding.inflate(getLayoutInflater());
...
//        getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
    ...
    void initSpecialities(int priority) {
        ...
        specialitiesPGAdapter = new SpecialitiesSSAdapter(this, specialitiespost);
                            ...
                            public boolean onInterceptTouchEvent(@NonNull RecyclerView rv, @NonNull MotionEvent e) {
                                ...
                                if (position != RecyclerView.NO_POSITION) {
                                    if (position == specialitiespost.size() - 1 && specialitiespost.get(position).getPriority() == -1) {
                                        Intent intent = new Intent(PreparationSubCategorySSActivity.this, SpecialitySlideshowInsiderActivity.class);
