...
public class exclusiveadapter extends RecyclerView.Adapter<exclusiveadapter.ViewHolder> {
    ...
    public exclusiveadapter(Context context, List<CourseCard> courseCardList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.featured_card2, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (title.length() > 55) {
            holder.titleTextView.setText(title.substring(0, 55) + "...");
        } else {
        ...
        if (subtitle.length() > 60) {
            holder.subtitleTextView.setText(subtitle.substring(0, 60) + "...");
        } else {
