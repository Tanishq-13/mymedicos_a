    ...
    public class WeeklyFmgeQuizAdapterinsider extends RecyclerView.Adapter<WeeklyFmgeQuizAdapterinsider.WeeklyFmgeQuizQuestionViewHolder> {

        private Context context;
        private ArrayList<QuizFmgeinsider> quizquestionsweekly;
        ...
        public WeeklyFmgeQuizAdapterinsider(Context context, ArrayList<QuizFmgeinsider> quiz, OnOptionInteractionListener interactionListener) {
        ...
        @NonNull
        @Override
        public WeeklyFmgeQuizQuestionViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(context).inflate(R.layout.question_quiz_design_weekly, parent, false);
            return new WeeklyFmgeQuizQuestionViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull WeeklyFmgeQuizQuestionViewHolder holder, @SuppressLint("RecyclerView") int position) {
            QuizFmgeinsider quizquestion = quizquestionsweekly.get(position);
            Log.d("btadoo2929",String.valueOf(quizquestionsweekly.get(position)));
            ...
            if (selectedOption != null && !selectedOption.isEmpty()) {
                ...
                String htmlDescription = quizquestion.getDescription()
                        .replace("<p>", "<br>")
                        .replace("</p>", "")
                        .replace("<ul>", "")
                        .replace("</ul>", "")
        ...
        private void setOptionClickListeners(WeeklyFmgeQuizAdapterinsider.WeeklyFmgeQuizQuestionViewHolder holder, int position) {
    ...
    //    }
        ...
        private void showBottomSheetAgain() {
            QuizFmgeinsider currentQuestion = quizquestionsweekly.get(currentQuestionIndex);
        ...
        private void handleOptionClick(WeeklyFmgeQuizAdapterinsider.WeeklyFmgeQuizQuestionViewHolder holder, String option, int position) {
            ...
            if (quizquestion.getSelectedOption() == null || quizquestion.getSelectedOption().isEmpty()) {
                ...
                holder.binding.description.setVisibility(View.VISIBLE);
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
                    holder.binding.description.setText(Html.fromHtml(quizquestion.getDescription(), Html.FROM_HTML_MODE_COMPACT));
                } else {
                    holder.binding.description.setText(Html.fromHtml(quizquestion.getDescription()));
                }
        ...
        private void disableOptionClicks(WeeklyFmgeQuizAdapterinsider.WeeklyFmgeQuizQuestionViewHolder holder) {
    ...
    //    }
        ...
        public void setQuizQuestions(List<QuizFmgeinsider> quizQuestions) {
        ...
        private void showOptionsAndDescription(QuizFmgeinsider quizQuestion, WeeklyFmgeQuizQuestionViewHolder holder) {
    ...
    //        disableOptionSelection();
        ...
        public void resetButtonColors1(WeeklyFmgeQuizQuestionViewHolder holder) {
            // Reset option A
        ...
        private void showNoOptionSelectedDialog(QuizPGinsider quizquestion,WeeklyFmgeQuizQuestionViewHolder holder) {
    ...
    //        }
        ...
        private void setOptionSelectedStyle(WeeklyFmgeQuizQuestionViewHolder holder, String selectedOption) {
        ...
        private void resetOptionStyle(WeeklyFmgeQuizAdapterinsider.WeeklyFmgeQuizQuestionViewHolder holder) {
        ...
        private void highlightSelectedAndCorrectAnswer(WeeklyFmgeQuizAdapterinsider.WeeklyFmgeQuizQuestionViewHolder holder, String selectedOption, String correctAnswer) {
            if (selectedOption.equals(correctAnswer)) {
                // If the selected option is correct, highlight it in green
                setOptionStyle(holder, selectedOption, Color.GREEN);
            } else {
                // If the selected option is wrong, highlight it in red and correct answer in green
                setOptionStyle(holder, selectedOption, Color.RED);
                setOptionStyle(holder, correctAnswer, Color.GREEN);
            }
        }
        @Override
        ...
        private void setOptionStyle(WeeklyFmgeQuizAdapterinsider.WeeklyFmgeQuizQuestionViewHolder holder, String option, int color) {
            Log.d("bghalo","g");
            switch (option) {
                case "A":
                    holder.binding.optionA.setBackgroundResource(R.drawable.correct_option_background);
                    break;
                case "B":
                    holder.binding.optionB.setBackgroundResource(R.drawable.correct_option_background);
                    break;
                case "C":
                    holder.binding.optionC.setBackgroundResource(R.drawable.correct_option_background);
                    break;
                case "D":
                    holder.binding.optionD.setBackgroundResource(R.drawable.correct_option_background);
                    break;
            }
        }
        public class WeeklyFmgeQuizQuestionViewHolder extends RecyclerView.ViewHolder {

            QuestionQuizDesignWeeklyBinding binding;

            public WeeklyFmgeQuizQuestionViewHolder(@NonNull View itemView) {
                super(itemView);
