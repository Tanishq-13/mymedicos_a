...
public class ExamUpcomingAdapter extends RecyclerView.Adapter<ExamUpcomingAdapter.ExamUpcomingViewHolder> {
    ...
    private void fetchSubscriptionStatusAndAdjustUI(ExamUpcomingViewHolder holder, QuizPGExam quiz) {
    ...
    public class ExamUpcomingViewHolder extends RecyclerView.ViewHolder {
        ...
        private void checkSubscriptionAndProceed(Runnable onSuccess, Runnable onFailure,QuizPGExam quiz) {
