...
public class QuestionbankFragment extends Fragment {
    ...
    private QuestionBankSSAdapter questionsAdapter;

    LottieAnimationView nodatafound;
    private ArrayList<QuestionSS> questionsforpg;
    private int catId;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        questionsAdapter = new QuestionBankSSAdapter(requireContext(), questionsforpg);
