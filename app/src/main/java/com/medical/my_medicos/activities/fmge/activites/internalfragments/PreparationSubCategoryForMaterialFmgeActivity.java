...
import com.medical.my_medicos.activities.fmge.adapters.SpecialityFMGEForMaterialAdapter;
...
import com.medical.my_medicos.databinding.ActivityPreparationSubCategoryforMaterialFmgeBinding;
...
public class PreparationSubCategoryForMaterialFmgeActivity extends AppCompatActivity {

    ActivityPreparationSubCategoryforMaterialFmgeBinding binding;
    SwipeRefreshLayout swipeRefreshLayoutPreparationCategory;
    SpecialityFMGEForMaterialAdapter specialitiesPGAdapter;
    ArrayList<SpecialitiesFmge> specialitiespost;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityPreparationSubCategoryforMaterialFmgeBinding.inflate(getLayoutInflater());
...
//        getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
    ...
    void initSpecialities(int priority) {
        ...
        specialitiesPGAdapter = new SpecialityFMGEForMaterialAdapter(this, specialitiespost);
                            ...
                            public boolean onInterceptTouchEvent(@NonNull RecyclerView rv, @NonNull MotionEvent e) {
                                ...
                                if (position != RecyclerView.NO_POSITION) {
                                    if (position == specialitiespost.size() - 1 && specialitiespost.get(position).getPriority() == -1) {
                                        Intent intent = new Intent(PreparationSubCategoryForMaterialFmgeActivity.this, SpecialitySlideshowInsiderActivity.class);
