package com.medical.my_medicos.activities.fmge.activites.internalfragments.Preprationindexing.adapter.Twgt;
...
public class PreprationTwgtPageAdapter extends FragmentStateAdapter {
    ...
    public Fragment createFragment(int position) {
        switch (position) {
            ...
            case 2:
                return PreprationIndexFMGETwgtBookmark.newInstance(speciality);
            default:
                return PreprationIndexingTwgtAll.newInstance(speciality);
        }
    }
