...
import com.medical.my_medicos.databinding.FragmentResearchPaperBinding;
...
public class ResearchPaperFragment extends Fragment {
    ...
    private FragmentResearchPaperBinding binding;
    ...
    public static ResearchPaperFragment newInstance(int catId, String categoryName) {
        ResearchPaperFragment fragment = new ResearchPaperFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentResearchPaperBinding.inflate(inflater, container, false);
        View view = binding.getRoot();

        products = new ArrayList<>();
        productAdapter = new ProductAdapter(requireContext(), products);

        RecyclerView recyclerView = binding.recyclerViewResearchPaper;
        GridLayoutManager layoutManager = new GridLayoutManager(requireContext(), 1);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setAdapter(productAdapter);

        TextView categoryNameTextView = view.findViewById(R.id.titleofthecategorywillcomehereresearch);
        categoryNameTextView.setText(categoryName);

        getResearchPapers(catId);
    ...
    private void getResearchPapers(int catId) {
            ...
            try {
                ...
                if (object.getString("status").equals("success")) {
                    ...
                    for (int i = 0; i < productsArray.length(); i++) {
                        ...
                        if (productObj.getString("Type").equalsIgnoreCase("Research")) {
