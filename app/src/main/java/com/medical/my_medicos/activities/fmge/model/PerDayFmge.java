...
public class PerDayFmge implements Item, Serializable {

    private String question, optiona, optionb,optionc,optiond, checkbtn,idquestion, description;

    public PerDayFmge(String DailyQuestion, String optionA, String optionB, String optionC, String optionD, String SubmitAnswer,String idQuestion, String description) {
