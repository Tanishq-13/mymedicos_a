...
public class NotesAdapter extends RecyclerView.Adapter<com.medical.my_medicos.activities.neetss.activites.internalfragments.Preprationindexing.adapter.NotesAdapter.ViewHolder> {
    ...
    private com.medical.my_medicos.activities.neetss.activites.internalfragments.Preprationindexing.adapter.NotesAdapter.OnNoteClickListener listener;
    private FirebaseFirestore db;
    private FirebaseAuth auth;
    private Context context;

    public NotesAdapter(List<com.medical.my_medicos.activities.neetss.activites.internalfragments.Preprationindexing.Model.Index.NotesData> notesList, com.medical.my_medicos.activities.neetss.activites.internalfragments.Preprationindexing.adapter.NotesAdapter.OnNoteClickListener listener, Context context) {
    ...
    @NonNull
    @Override
    public com.medical.my_medicos.activities.neetss.activites.internalfragments.Preprationindexing.adapter.NotesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_note, parent, false);
        return new com.medical.my_medicos.activities.neetss.activites.internalfragments.Preprationindexing.adapter.NotesAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull com.medical.my_medicos.activities.neetss.activites.internalfragments.Preprationindexing.adapter.NotesAdapter.ViewHolder holder, int position) {
        com.medical.my_medicos.activities.neetss.activites.internalfragments.Preprationindexing.Model.Index.NotesData note = notesList.get(position);
    ...
    private void checkSubscriptionStatusAndAdjustUI(com.medical.my_medicos.activities.neetss.activites.internalfragments.Preprationindexing.adapter.NotesAdapter.ViewHolder holder, com.medical.my_medicos.activities.neetss.activites.internalfragments.Preprationindexing.Model.Index.NotesData note) {
    ...
    private void handlePaidNoteClick(com.medical.my_medicos.activities.neetss.activites.internalfragments.Preprationindexing.adapter.NotesAdapter.ViewHolder holder, com.medical.my_medicos.activities.neetss.activites.internalfragments.Preprationindexing.Model.Index.NotesData note) {
        String userId = auth.getCurrentUser().getPhoneNumber();
        DocumentReference docRef = db.collection("Subscription").document(userId);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageView lockIcon, unlockIcon;
        ...
        public ViewHolder(View view) {
            ...
            unlockIcon = view.findViewById(R.id.unlock);
        }
