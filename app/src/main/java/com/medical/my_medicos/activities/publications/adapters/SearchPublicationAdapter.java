...
import com.medical.my_medicos.databinding.ItemProductSearchPublicationBinding;

import java.util.List;

public class SearchPublicationAdapter extends RecyclerView.Adapter<SearchPublicationAdapter.ProductViewHolder> {

    private final Context context;
    private final List<Product> products;
    private OnItemClickListener onItemClickListener;

    public SearchPublicationAdapter(Context context, List<Product> products) {
    ...
    public class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        ItemProductSearchPublicationBinding binding;

        public ProductViewHolder(@NonNull View itemView) {
            super(itemView);
            binding = ItemProductSearchPublicationBinding.bind(itemView);
