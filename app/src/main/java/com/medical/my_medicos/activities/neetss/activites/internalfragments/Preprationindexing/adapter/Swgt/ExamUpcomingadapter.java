...
public class ExamUpcomingadapter extends RecyclerView.Adapter<ExamUpcomingadapter.ExamUpcomingViewHolder> {
    ...
    private void fetchSubscriptionStatusAndAdjustUI(ExamUpcomingViewHolder holder, QuizSSExam quiz) {
    ...
    public class ExamUpcomingViewHolder extends RecyclerView.ViewHolder {
        ...
        private void checkSubscriptionAndProceed(Runnable onSuccess, Runnable onFailure,QuizSSExam quiz) {
