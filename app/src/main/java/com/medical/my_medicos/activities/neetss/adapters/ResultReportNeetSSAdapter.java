...
public class ResultReportNeetSSAdapter extends RecyclerView.Adapter<ResultReportNeetSSAdapter.ResultSSViewHolder> {

    private Context context;
    private ArrayList<Neetss> quizList;

    public ResultReportNeetSSAdapter(Context context, ArrayList<Neetss> quizList) {
    ...
    public void onBindViewHolder(@NonNull ResultSSViewHolder holder, int position) {
        Neetss quizQuestion = quizList.get(position);
