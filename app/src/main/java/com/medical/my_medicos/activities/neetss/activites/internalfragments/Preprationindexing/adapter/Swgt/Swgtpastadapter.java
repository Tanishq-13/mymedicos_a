...
public class Swgtpastadapter extends RecyclerView.Adapter<Swgtpastadapter.ExamPastViewHolder> {
    ...
    public Swgtpastadapter(Context context, ArrayList<QuizSSExam> quizList) {
    ...
    private void fetchSubscriptionStatusAndAdjustUI(ExamPastViewHolder holder, QuizSSExam quiz) {
    ...
    private void fetchSubscriptionStatusAndProceed(ExamPastViewHolder holder, QuizSSExam quiz) {
        String userId = auth.getCurrentUser().getPhoneNumber();
        DocumentReference docRef = db.collection("Subscription").document(userId);
