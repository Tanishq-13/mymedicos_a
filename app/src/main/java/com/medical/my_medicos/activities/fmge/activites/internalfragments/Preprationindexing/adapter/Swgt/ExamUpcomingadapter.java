...
public class ExamUpcomingadapter extends RecyclerView.Adapter<ExamUpcomingadapter.ExamUpcomingViewHolder> {
    ...
    public ExamUpcomingadapter(Context context, ArrayList<QuizFmgeExam> quizList) {
    ...
    private void fetchSubscriptionStatusAndAdjustUI(ExamUpcomingViewHolder holder, QuizFmgeExam quiz) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                if (isPlanActive != null && isPlanActive) {
                                    ...
                                    if (fieldArray != null && fieldArray.contains("PGNEET") && quiz.getType().equals(document.getString("hyOption"))) {
