...
import com.medical.my_medicos.activities.neetss.adapters.SpecialitySSForMaterialAdapter;
...
public class PreparationSubCategorySSForMaterialActivity extends AppCompatActivity {

    ActivityPreparationSubCategoryForMaterialBinding binding;
    SwipeRefreshLayout swipeRefreshLayoutPreparationCategory;
    SpecialitySSForMaterialAdapter specialitiesPGAdapter;
...
//        getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
    ...
    void initSpecialities(int priority) {
        ...
        specialitiesPGAdapter = new SpecialitySSForMaterialAdapter(this, specialitiespost);

        getSpecialitySS(priority);
    ...
    void getSpecialitySS(int priority) {
                    ...
                    if (mainObj.getString("status").equals("success")) {
                        ...
                        for (int i = 0; i < specialityArray.length(); i++) {
                            ...
                            if (objectPriority == priority) {
                                SpecialitiesSS speciality = new SpecialitiesSS(
                                        object.getString("id"),
                                        objectPriority
                                );
                            ...
                            public boolean onInterceptTouchEvent(@NonNull RecyclerView rv, @NonNull MotionEvent e) {
                                ...
                                if (position != RecyclerView.NO_POSITION) {
                                    if (position == specialitiespost.size() - 1 && specialitiespost.get(position).getPriority() == -1) {
                                        Intent intent = new Intent(PreparationSubCategorySSForMaterialActivity.this, SpecialitySlideshowInsiderActivity.class);
