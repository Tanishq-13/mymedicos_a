 ...
 */
public class ClinicalPgPrep extends Fragment implements PreparationPgFragment.SearchableFragment {
                    ...
                    if (documentSnapshot.contains("Clinical")) {
                        ...
                        for (String specialtyName : specialties) {
                            if (specialtyName != null) {
                                ...
                                fullCategoryItems.add(new SpecialitiesPG(specialtyName,1)); // Add to the full list for filtering
