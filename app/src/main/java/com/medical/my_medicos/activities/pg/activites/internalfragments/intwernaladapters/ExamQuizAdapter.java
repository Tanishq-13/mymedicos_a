...
public class ExamQuizAdapter extends RecyclerView.Adapter<ExamQuizAdapter.ExamViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ExamViewHolder holder, int position) {
        ...
        holder.noq.setText(quiz.getDatasize()+" MCQ's");
    ...
    private void fetchSubscriptionStatusAndAdjustUI(ExamViewHolder holder, QuizPGExam quiz) {
        String userId = auth.getCurrentUser().getPhoneNumber();
        if("Basic".equals(quiz.getType())||"Free".equals(quiz.getType())){
...
//                holder.unlock.setVisibility(View.GONE);
    ...
    private void fetchSubscriptionStatusAndProceed(ExamViewHolder holder, QuizPGExam quiz) {
        String userId = auth.getCurrentUser().getPhoneNumber();
        DocumentReference docRef = db.collection("Subscription").document(userId);
    ...
    public static class ExamViewHolder extends RecyclerView.ViewHolder {
        TextView titleTextView, dueDateTextView, categorytextview,noq;

        Button lock, unlock, pay;

        public ExamViewHolder(@NonNull View itemView) {
            super(itemView);
            titleTextView = itemView.findViewById(R.id.titleTextView);
            pay = itemView.findViewById(R.id.payfortheexam);
            noq=itemView.findViewById(R.id.tv_mcc);
        }
