...
public class Swgtquizadapter extends RecyclerView.Adapter<Swgtquizadapter.ExamViewHolder> {
    ...
    public Swgtquizadapter(Context context, ArrayList<QuizFmgeExam> quizList) {
    ...
    public void onBindViewHolder(@NonNull ExamViewHolder holder, int position) {
        ...
        if (quiz.getType().equals("Pro")||quiz.getType().equals("Premium")||quiz.getType().equals("Standard")) {
