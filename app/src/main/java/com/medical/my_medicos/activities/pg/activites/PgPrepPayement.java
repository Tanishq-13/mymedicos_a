    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        agreeCheckbox.setOnClickListener(v -> {
            if (agreeCheckbox.isChecked()) {
                ...
                Toast.makeText(PgPrepPayement.this, "Please agree to the terms to start the examination", Toast.LENGTH_SHORT).show();
...
//            TextView dueDateTextView = findViewById(R.id.DueDate);
            quizNameTextView.setText(quizTitle);
            dueDateTextView.setText(id);
...
//            TextView dueDateTextView = findViewById(R.id.DueDate);
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (id == null || id.isEmpty()) {
                    Toast.makeText(PgPrepPayement.this, "Document ID is not available.", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                .addOnSuccessListener(this, pendingDynamicLinkData -> {
                    if (pendingDynamicLinkData != null) {
                        ...
                        if (deepLink != null) {
                            ...
                            Intent intent = new Intent(PgPrepPayement.this, PgPrepPayement.class);
    ...
    private void toggleBookmark(ImageButton starButton, String quizId) {
        DatabaseReference bookmarkRef = database.child("profiles").child(phoneNumber).child("bookmarks").child(quizId);
        Log.d("chckbkmrk",String.valueOf(database.child("profiles")));
        if (isClicked) {
    ...
    private void startExamination() {
        if (agreeCheckbox.isChecked()) {
            Intent startExamIntent = new Intent(PgPrepPayement.this, WeeklyQuizInsiderActivity.class);
            ...
            startExamIntent.putExtra("section","PG");
