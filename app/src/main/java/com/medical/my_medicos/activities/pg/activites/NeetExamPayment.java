...
public class NeetExamPayment extends AppCompatActivity {
    ...
    private void showConfirmationDialog(String title, String title1) {
        ...
        builder.setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                showQuizInsiderActivity(title, title1, examId);
                dialog.dismiss();
            }
        });
    ...
    private void showQuizInsiderActivity(String title, String title1, String examId) {
        Intent intent = new Intent(NeetExamPayment.this, Neetexaminsider.class);
        intent.putExtra("Title1", title1);
//        Log.d("Show title1", title1);
        intent.putExtra("Title", title);
//        Log.d("Show title here", title);
        intent.putExtra("quiz_id", examId); // Pass the quiz ID to the next activity
