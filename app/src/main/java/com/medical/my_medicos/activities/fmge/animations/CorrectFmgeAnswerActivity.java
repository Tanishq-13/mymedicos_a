package com.medical.my_medicos.activities.fmge.animations;
...
public class CorrectFmgeAnswerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        complete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(CorrectFmgeAnswerActivity.this, FmgeprepActivity.class);
